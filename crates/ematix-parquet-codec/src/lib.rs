...
//!      Zstd/Gzip/Brotli/LZ4 later) producing decompressed page-body bytes.
//!   2. `plain`        — PLAIN encoding decoders, one per physical
//!      type (i32/i64/f32/f64/byte_array/...). This is the foundation:
//!      dictionary pages use PLAIN, and v2 fast-paths use it too.
//!   3. `dict`         — RLE_DICTIONARY data-page indices ↔ PLAIN
//!      dict values. Where most real columns end up after writers
//!      run a dictionary pass.
